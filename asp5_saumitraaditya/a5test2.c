...
*   change the mode, as count2 can never be brought to one, since both these threads will not execute release
*   as they are sleeping, also no one will wake them up because count2 will stay >1.                           
*********************** END NOTE *******************************************************************************                                                     
*/
char *DEVICE = "/dev/a5";
