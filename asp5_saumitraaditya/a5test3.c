...
********************** NOTE ***********************************************************************************
*
*   BENIGN DEADLOCK-- Ctrl-c will bring you back.
*   Deadlock is theoretically possible when multiple locks are involved
*   Use root to run this code, initially in Mode1.
*   Scenario:-
*   Thread1                     Thread2
*   open()--------------------------------------------------increments count1------------gets sem2
*                               open()----------------------increments count1------------blocks on sem2
*   pthread_exit()------------------------------------------- assume this thread is killed by the kernel or by the user, killing a thread does not free locks/semaphores.   
*                               close()    
*    
*     
*   This would result in a deadlock as sem2 wanted by Thread2 is never freed by Thread1.                                                       
*   I                          
*********************** END NOTE *******************************************************************************                                                     
*/
char *DEVICE = "/dev/a5";
